...
class Extent(models.Model):
    ...
    minLat = models.DecimalField(
        verbose_name=_("Latitude min"), max_digits=9, decimal_places=6
    )
    minLon = models.DecimalField(
        verbose_name=_("Longitude min"), max_digits=9, decimal_places=6
    )
    maxLat = models.DecimalField(
        verbose_name=_("Latitude max"), max_digits=9, decimal_places=6
    )
    maxLon = models.DecimalField(
        verbose_name=_("Longitude max"), max_digits=9, decimal_places=6
    )
