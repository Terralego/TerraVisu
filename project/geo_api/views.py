...
from django.db.models import Avg, Case, Count, FloatField, IntegerField, Max, Min, Value, When
...
class FeatureViewSet(MultipleFieldLookupMixin, PrefixBoostMixin,
                     AutoOrderMixin, GeostoreFeatureViewSet):
    ...
    def _format_feature_response(self, data, search_param):
        ...
        if search_param:
            self._inject_search_match(data.get("features", []), search_param)
        return data
